...
tg_sendinfo "<code>I am gonna merge staging into G-Bot</code>"
cd
...
git push --force origin staging:G-Bot
tg_sendinfo "<code>I have merged all commits from staging into G-Bot</code>"
